...
public class EmailController {
    ...
    public String sendMail(String mailTo){
        ...
        //设置邮件内容
        String mailText = "【华农二手交易市场】 验证码："+verifycode+"   您正在注册华农二手交易网账号，请勿将验证码告诉他人哦。";
    ...
    public void sendMailToUser(@RequestBody Map<String,Object> map){
        ...
        for (Map<String, String> arr:list) {
            String mailText = "您在【华农二手市场】网站发布的《"+arr.get("name")+"》已出售";
    ...
    public void sendMailToBuyer(@RequestBody Map<String,Object> map){
        ...
        if(type == 2){
            String mailText = "【华农二手市场】您购买的《"+MapObject.get("name")+"》已发货";
            toMail(MapObject.get("mail"),mailText);
        }else if(type == 3){
            String mailText = "【华农二手市场】您发布的《"+MapObject.get("name")+"》已送达";
            toMail(MapObject.get("mail"),mailText);
        }else if(type == 4){
            String mailText = "【华农二手市场】您出售的《"+MapObject.get("name")+"》正在申请退款，请及时处理！";
            toMail(MapObject.get("mail"),mailText);
        }else if(type == 5){
            String mailText = "【华农二手市场】您购买的《"+MapObject.get("name")+"》退款成功！";
            toMail(MapObject.get("mail"),mailText);
        }else if(type == 6){
            String mailText = "【华农二手市场】您购买的《"+MapObject.get("name")+"》退款失败！";
            toMail(MapObject.get("mail"),mailText);
        }
    }
    ...
    public void toMail(String mailTo,String mailText){
        //定义发送标题
        String title = "华农二手交易市场";
        //设置发送方
        String mailFrom = "lxy13628688240@163.com";
        try {
            //构建邮件对象
